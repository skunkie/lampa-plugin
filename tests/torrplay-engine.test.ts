...
describe('TorrPlayEngine', () => {
  ...
  it('shows error notification when neither valid info hash nor magnet link is present', async () => {
    ...
    await TorrPlayEngine.saveToDatabase({
      Link: 'http://example.com/movie.torrent',
  ...
  it('renders multi-file torrents with the native TorrServer file dialog', () => {
    ...
    displayFileList(
      ...
      {
        files: [
          { index: 0, length: 1000, name: 'episode.01.mkv', path: 'episode.01.mkv' },
          { index: 1, length: 2000, name: 'episode.02.mp4', path: 'episode.02.mp4' },
        ],
        hash: 'multi123',
        name: 'Series',
        storage: 'memory',
  ...
  it('displays multi-file torrents in natural sorted order and resolves correct file_index', () => {
    ...
    displayFileList(
      ...
      {
        files: [
          { index: 0, length: 1000, name: 'part-10.mp4', path: 'part-10.mp4' },
          { index: 1, length: 1000, name: 'part-1.mp4', path: 'part-1.mp4' },
          { index: 2, length: 1000, name: 'part-2.mp4', path: 'part-2.mp4' },
        ],
        hash: 'multi-sort',
        name: 'Part Series',
        storage: 'memory',
